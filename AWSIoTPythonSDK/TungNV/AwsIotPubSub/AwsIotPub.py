...
#
# http://www.apdaga.com/2018/02/install-aws-amazon-sdk-on-raspberry-pi.html
############################################
...
awshost = "avt6g3kvwjn2o.iot.ap-southeast-1.amazonaws.com"  # Endpoint
awsport = 443  # Port no.
clientId = "BasicPubSubPython"  # Thing_Name
thingName = "BasicPubSubPython"  # Thing_Name
caPath = "D:\MyFolder\TUNG\MyPython\AWSIoTPythonSDK\TungNV\Certificate\BasicPubSubPython\\rootCA.pem"  # Root_CA_Certificate_Name
certPath = "D:\MyFolder\TUNG\MyPython\AWSIoTPythonSDK\TungNV\Certificate\BasicPubSubPython\\44432477c8-certificate.pem"  # <Thing_Name>.cert.pem
keyPath = "D:\MyFolder\TUNG\MyPython\AWSIoTPythonSDK\TungNV\Certificate\BasicPubSubPython\\44432477c8-private.pem.key"  # <Thing_Name>.private.key

print("awshost = ", awshost)
print("awsport = ", awsport)
